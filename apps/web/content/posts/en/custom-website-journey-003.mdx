...
From first plan to first deployment, it took about 8 days to complete.

Pure development time came to around 19 hours — spread across days rather than in one stretch, which pushed it a bit longer than I'd originally estimated.
...
The source code is on [GitHub](https://github.com/JeromeCheon/hijero.me).
